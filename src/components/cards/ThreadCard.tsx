...
const ThreadCard = ({
    ...
    return (
        <div className={clsx('flex w-full flex-col rounded-xl', isComment ? 'px-0 xs:px-7' : 'bg-dark-2 p-7')}>
                    ...
                    <div className='flex flex-col items-center'>
                        <Link href={`/profile/${author.id}`} className='relative h-11 w-11'>
                            ...
                            <div className='relative h-11 w-11 object-cover'>
                                <Image src={author.image} alt='Profile Photo' fill className='rounded-full object-cover' />
                            </div>
